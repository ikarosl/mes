-- Trigger local character variables otherwise inherit collation_connection, which may differ from schema columns.
-- Execute with inventory writers stopped; MySQL trigger DDL is not transactional.
