...
const knownIdempotencyScopes = [
  ...
  'production.output.inspection.v1',
  ...
  'production.work-order.material-configuration.save.v1',
  ...
  'production.material-loss.create.v2',
  'production.material-loss.confirm.v2',
...
const checks = [
  ...
  // 当前登记的幂等用例必须显式列入本白名单并具备版本化契约与测试。
  {
    ...
    exclude: [
      ...
      'apps/api/src/modules/production/application/work-order-material-configuration.service.ts',
      ...
      'apps/api/src/modules/production/presentation/http/work-order-material-configuration.controller.ts',
